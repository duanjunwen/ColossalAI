...
class MoeHybridParallelPlugin(HybridParallelPlugin):
    ...
    def __init__(
        ...
        print(f"ep_group_ranks: {self.moe_info.ep_group_ranks} , dp_group_ranks: {self.moe_info.dp_group_ranks}, ep_rank:{self.moe_info.ep_rank}, dp_rank: {self.moe_info.dp_rank}")
